...
<body>
    ...
    <table class="table">
            <button class="btn btn-secondary"><a href="delete.php" class ="text-white"> Delete </a></button>
            <button style= "margin-left:50px" class="btn btn-primary"><a href="add.php" class ="text-black"> Add New </a></button>
           <br>
    <thead> 
    <tr>
      <th scope="col">ID</th>
